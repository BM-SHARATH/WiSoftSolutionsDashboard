...
//   return (
//     <div className="bg-[#232323] min-h-[calc(100vh-80px)] flex flex-col justify-center py-10 ">
//       <section className="w-full max-w-7xl mx-auto px-2 sm:px-6">
//         <h2 className="uppercase text-lg font-semibold tracking-wide mb-8 text-white">
...
//             <div
//               key={i}
//               className="bg-white text-black rounded-lg shadow-lg p-6 w-full max-w-xs flex flex-col justify-between"
//             >
